                  ...
                  child: Row(
                    children: [
                      Column(
                        ...
                        children: [
                          Text(
                            '${controladorPaginaCarrinho.calcularTotalQuantidade()} produtos',
                            style: const TextStyle(fontSize: 15),
                          ),
                          Text(
                            NumberFormat.currency(locale: 'pt_BR', symbol: 'R\$').format(controladorPaginaCarrinho.calcularValorTotal()),
