...
import '../../../pagina_loja/controller/controlador_pagina_loja.dart';

class RodaPeCarrinhoQuantidadeValorTotal extends StatelessWidget {
  const RodaPeCarrinhoQuantidadeValorTotal({super.key});
